                ...
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 30%; border: none">
                                    <a style="width: 135px; padding: 10px; cursor:pointer;" data-toggle="modal"
                                        data-target="#orderModal{{ $pisoWifi->id }}"><i class='bx bxs-cart'></i>
                                        Purchase Item</a>
                            ...
                            <!-- View Modal -->
                            <div class="modal fade" id="productModal{{ $pisoWifi->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $pisoWifi->id }}" aria-hidden="true"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Status:</label>
                                                <input class="form-control" type="text" value="{{ $pisoWifi->Status }}"
                                                    disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Stocks Purchased: </label>
                                            ...
                                            <div class="form-group">
                                                <label>Remarks:</label>
                                                <input class="form-control" type="text" value="{{ $pisoWifi->Remarks }}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Order Modal -->
                            <div class="modal fade" id="orderModal{{ $pisoWifi->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="orderModalLabel{{ $pisoWifi->id }}" aria-hidden="true"
                                data-bs-backdrop="static">
                                            ...
                                            <form action="/orders" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label for="customer_id">Customer
                                                        <a href="#addCustomerModal" data-toggle="modal"
                                                            data-dismiss="modal" style="color: #4CA7DF; padding: 10px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="item_name"
                                                        id="orderModalLabel{{ $pisoWifi->id }}" class="form-control"
                                                        value="{{ $pisoWifi->ItemsName }}">
                                                </div>

                                                <div class="form-group">
                                                    <label for="product_type" hidden></label>
                                                    <input type="text" name="product_type" value="pisowifi_parts"
                                                        hidden>
                                                </div>

                                                <div class="form-group">
                                                    <label for="product_id" hidden></label>
                                                    <input type="text" name="product_id" value="{{ $pisoWifi->id }}"
                                                        hidden>
                                                </div>
                                                ...
                                                <div>
                                                    <input type="number" name="product_id" value="{{ $pisoWifi->id }}"
                                                        hidden>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="category" id="category"
                                                        value="Pisowifi-Parts-Accessories" class="form-control" hidden>
                                                </div>
                            ...
                            <!--Edit Item Modal-->
                            <div class="modal fade" id="productModalEdit{{ $pisoWifi->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $pisoWifi->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input class="form-control" type="number" name="StocksPurchased"
                                                    ...
                                                    <input class="form-control" type="number" name="RemainingStocks"
                                                        value="{{ $pisoWifi->RemainingStocks }}">

                                                    <p>Upcoming Stocks:</p>
                                                    <input class="form-control" type="number" name="UpcomingStocks"
                            ...
                            <div class="modal fade" id="deleteModal{{ $pisoWifi->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="deleteModalLabel{{ $pisoWifi->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
