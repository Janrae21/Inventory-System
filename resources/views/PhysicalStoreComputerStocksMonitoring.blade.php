                ...
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                                ...
                                <td style="width: 30%; border: none">
                                    @if ($ps->RemainingStocks > 0)
                                        <a style="width: 135px; padding: 10px; cursor:pointer;" data-toggle="modal"
                                            data-target="#orderModal{{ $ps->id }}"><i class='bx bxs-cart'></i> Purchase Item</a>
                                    @else
                            ...
                            <!-- Order Modal -->
                            <div class="modal fade" id="orderModal{{ $ps->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="orderModalLabel{{ $ps->id }}" aria-hidden="true">
                                            ...
                                            <form action="/orders" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="item_name" required
                                                        id="orderModalLabel{{ $ps->id }}" class="form-control"
                                                        value="{{ $ps->ItemsName }}">
                            ...
                            <!--View Product Modal-->
                            <div class="modal fade" id="productModal{{ $ps->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $ps->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Status:</label>
                                                <input class="form-control" type="text" value="{{ $ps->Status }}"
                                                    disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Stocks Purchased:</label>
                                            ...
                                            <div class="form-group">
                                                <label>Remarks:</label>
                                                <input class="form-control" type="text" value="{{ $ps->Remarks }}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!--Edit Item Modal-->
                            <div class="modal fade" id="productModalEdit{{ $ps->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $ps->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="deleteModal{{ $ps->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="deleteModalLabel{{ $ps->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
