                ...
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                                            ...
                                            <form action="/orders" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="item_name"
                                                        id="orderModalLabel{{ $pe->id }}" class="form-control"
                                                        value="{{ $pe->ItemsName }}" >
                                                ...
                                                <div class="form-group" hidden>
                                                    ...
                                                    <input type="text" name="product_id" value="{{ $pe->id }}" hidden>
                                                </div>

                                                <div class="form-group" hidden>
                                                    <label for="product_type" hidden></label>
                                                    <input type="text" name="product_type" value="eloading" hidden>
                                                </div>
                                                ...
                                                <div class="form-group" hidden>
                                                    ...
                                                    <input type="text" name="category" id="category"
                                                        value="Eloading-Parts-And-Accessories" class="form-control"
                                                        hidden>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="payment_method" id="payment_method"
                                                        ...
                                                        <option value="Other Online Banks">Other Online Banks</option>
                            ...
                            <!-- View Modal -->
                            <div class="modal fade" id="productModal{{ $pe->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Status:</label>
                                                <input class="form-control" type="text" value="{{ $pe->Status }}"
                                                    disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Stocks Purchased:</label>
                                            ...
                                            <div class="form-group">
                                                <label>Remarks:</label>
                                                <input class="form-control" type="text" value="{{ $pe->Remarks }}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!--Edit Item Modal-->
                            <div class="modal fade" id="productModalEdit{{ $pe->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $pe->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="deleteModal{{ $pe->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="deleteModalLabel{{ $pe->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
