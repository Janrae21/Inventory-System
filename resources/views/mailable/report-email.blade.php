            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="middle" class="hero bg_white" style="padding: 20px">
                        ...
                        <h3 style="font-size: 15px">{{ $product }} has reached the limit treshold </h3>

                        <p style="margin-bottom: 0"><b>Regards:</b></p>
                        <p style="margin: 0">FlareGo System</p><br>

                        <hr style="border-top: 1px solid rgb(207, 207, 207)">
                        <br>
                        {{-- <p style="margin: 0">
                            If you're having trouble clicking the "View Request" button, copy or click the URL
                            below into your web browser: <a href="/" target="_blank">
                                <b> </b>
                            </a>
                        </p> --}}
                    </td>
