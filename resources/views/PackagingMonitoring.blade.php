                ...
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <!-- Order Modal -->
                            <div class="modal fade" id="orderModal{{ $pm->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="orderModalLabel{{ $pm->id }}" aria-hidden="true"
                                            ...
                                            <form action="/orders" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="item_name"
                                                        id="orderModalLabel{{ $pm->id }}" class="form-control"
                                                        value="{{ $pm->ItemsName }}">
                                                </div>
                            ...
                            <!-- View Modal -->
                            <div class="modal fade" id="productModal{{ $pm->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $pm->id }}" aria-hidden="true"
                                data-bs-backdrop="static">
                            ...
                            <!--Edit Item Modal-->
                            <div class="modal fade" id="productModalEdit{{ $pm->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="productModalLabel{{ $pm->id }}" aria-hidden="true"
                                data-bs-backdrop="static">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                            ...
                            <div class="modal fade" id="deleteModal{{ $pm->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="deleteModalLabel{{ $pm->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
